            ...
            <ul className="my-2 h-full text-accentColor">
              ...
              <li className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e) => { setFormFilter({ ...formFilter, tops: !formFilter.tops }) }}
                />
                <label>Tops</label>
              </li>
              <li className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e) => { setFormFilter({ ...formFilter, bottoms: !formFilter.bottoms }) }}
                />
                <label>Bottoms</label>
              </li>
              <li className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e) => { setFormFilter({ ...formFilter, accessories: !formFilter.accessories }) }}
                />
              ...
              <li className="flex items-center mb-2">
                <input
                  ...
                  onChange={(e) => { setFormFilter({ ...formFilter, grooming: !formFilter.grooming }) }}
                />
