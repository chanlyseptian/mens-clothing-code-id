    ...
    <div>
      <div className="grid md:grid-cols-12 sm:grid-cols-1 px-10 lg:px-32 lg:ml-52 3xl:ml-12">
        <div className="md:col-span-6 sm:col-span-12 sm:min-h-screen mx-auto">
          ...
          <div className="max-w-xl">
            ...
            >
              ...
              <h1 className = "text-base rounded-md  text-cyan-800 font-bold top-2 right-0 absolute hover:text-cyan-600 hover:scale-125 cursor-pointer">EDIT</h1>
            </div>
            <img
        ...
        <div className="mt-20 3xl:mt-24 ">
          ...
          <h1 className="text-xl font-semibold pt-10 pb-1 text-cyan-900">UserType</h1>
